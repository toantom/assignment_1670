...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="{{URL::asset('public/backend/plugins/fontawesome-free/css/all.min.css')}}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{URL::asset('public/backend/css/adminlte.min.css')}}">
  <!-- DataTables -->
  <link rel="stylesheet" href="{{URL::asset('public/backend/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')}}">
  <link rel="stylesheet" href="{{URL::asset('public/backend/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')}}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{URL::asset('public/backend/plugins/daterangepicker/daterangepicker.css')}}">
  <!-- Ionicons -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto" >
      <a onclick="return sweetConfirm('Are you sure to logout?')" href="{{route('backend.logout')}}" class="nav-link" style="color: red">Logout</a>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('backend.index')}}" class="brand-link">
      <img src="{{URL::asset('public/backend/picture/logo.PNG')}}" alt="AdminLTE Logo" class="brand-image elevation-3" >
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="https://icheck.com.vn/wp-content/uploads/2020/11/avatar-default.png" class="img-circle elevation-2" alt="User Image" width="128px" height="128px">
        </div>
        <div class="info">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy;<a href="https://greenwich.edu.vn/">Greenwich University (VietNam)</a>.
  </footer>
</div>
<!-- ./wrapper -->
